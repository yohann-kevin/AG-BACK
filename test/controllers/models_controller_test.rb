...
class ModelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should update model" do
    patch model_url(@model), params: { model: { address: @model.address, birth_date: @model.birth_date, email: @model.email, firstname: @model.firstname, lastname: @model.lastname, phone: @model.phone } }, as: :json
    assert_response 200
  end
